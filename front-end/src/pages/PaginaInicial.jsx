        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 mt-25">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Gerencie seus clientes e pedidos de forma eficiente com nossa
          ...
          <div className="grid grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Gerencie seu banco de clientes, visualize histórico e mantenha
                relacionamentos
              </p>
            ...
            >
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Acompanhe todos os pedidos, status de entrega e histórico de
                vendas
              </p>
