    ...
    public function up()
    {
      DB::statement("
        CREATE TABLE PEDIDOS(
          ...
          FOREIGN KEY (COD_ENDERECO_CLIENTE) REFERENCES ENDERECOS_CLIENTES(COD_ENDERECO_CLIENTE) ON DELETE CASCADE
          FOREIGN KEY (COD_FUNCIONARIO) REFERENCES FUNCIONARIOS_CRM(COD_FUNCIONARIO) ON DELETE CASCADE
        );
      ");
